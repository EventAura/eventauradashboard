...
const EventOnboardingForm = () => {
  ...
  // Fix the handleAddOption function to properly handle potentially undefined options
  const handleAddOption = (index: number) => {
    const newQuestions = [...eventQuestions];
    
    // Create options array if it doesn't exist
    if (!newQuestions[index].options) {
      newQuestions[index].options = [];
    }
    
    // Now it's safe to push a new option since we've ensured options exists
