...
//           // setEventQuestions(eventData.eventQuestions)
//           setEventDate(new Date(eventData.eventDate))
//           setEventLastDate(new Date(eventData.eventLastDate))
...
//     try {
//       const url = eventId ? `http://localhost:8080/event/${eventId}` : "http://localhost:8080/event"
...
//               <h3 className="text-3xl font-bold sm:text-4xl">{eventId ? "Edit Event" : "Host Your Event Here!"}</h3>
...
//               {/* Event Questions Section (Commented Out) */}
